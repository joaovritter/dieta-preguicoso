  ...
  return (
    <Tela gap={26}>
      <Box sx={{ display: 'flex', alignItems: 'center', gap: '14px', pt: '4px' }}>
        <ButtonBase onClick={() => navigate('/perfil')} sx={{ minHeight: 32, fontFamily: 'inherit', fontWeight: 600, fontSize: 13, color: 'text.secondary' }}>
          ← voltar
        </ButtonBase>
        <Typography component="h1" sx={{ m: 0, flex: 1, fontWeight: 800, fontSize: 22, letterSpacing: '-.02em' }}>
          configurações
        </Typography>
      </Box>
      ...
      <Secao rotulo="perfil">
        <LinhaLista rotulo="editar dados" chevron onClick={() => navigate('/perfil/dados')} />
      ...
      <Secao rotulo="notificações">
        <LinhaLista rotulo="preferências" valor={<Box component="span" sx={valorFraco}>em breve</Box>} ultima />
      </Secao>
