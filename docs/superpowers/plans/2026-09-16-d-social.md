...
- Plano B (Task 8): `ConfirmacaoRegistro` é um `Drawer` inferior (raio `26px 26px 0 0`, escuro `20px` + borda superior `neutro.borda`, `bgcolor: background.default`, `maxWidth 480`, padding 22) — os modais de captura da Task 11 seguem essa mesma folha.
...
/** Folha que sobe de baixo — mesmo formato da confirmação da IA (plano B, Task 8). */
